...
const AddService = ({ editService, restrictPermission, setEditService }) => {
    ...
    const onSubmit = async data => {
        ...
        if (!editService || (editService && img)) {
            ...
            imageData.set('key', 'fb480ec05315d34f8f16b038f8304a3a');
        ...
        if (editService) {
            ...
            axios.patch(`https://hidden-beyond-66408.herokuapp.com/${editService._id}`, serviceInfo)
                .then(res => {
                    toast.dismiss(loading);
                    if (res.data) {
        ...
        axios.post('https://hidden-beyond-66408.herokuapp.com/addService', serviceInfo)
            .then(res => {
                toast.dismiss(loading);
                if (res.data) {
                                ...
                                !imgPreview &&
                                    ...
                                    <>
                                        <Button
                                            ...
                                            <FontAwesomeIcon icon={faCloudUploadAlt} className="mr-2" />Toy Image
                                        </Button>
                                        <Form.Control
                                            hidden="hidden"
                                            id="upload"
